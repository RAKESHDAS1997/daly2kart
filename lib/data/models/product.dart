  ...
  Product.fromJson(Map<String, dynamic> json)
      : id = json['id'] as int?,
        attributes = (json['attributes'] as List?)
            ?.map((dynamic e) => Attribute.fromJson(e as Map<String, dynamic>))
            .toList(),
        ...
        minimumOrderQuantity =
            int.tryParse(json['minimum_order_quantity'].toString()) ?? 0,
        quantityStepSize = json['quantity_step_size'] as int?,
        totalAllowedQuantity = json['total_allowed_quantity'] as int?,
