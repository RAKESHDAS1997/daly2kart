...
import 'package:eshop_pro/ui/screens/productFilters/widgets/brandsFilterView.dart';
import 'package:eshop_pro/ui/screens/productFilters/widgets/categoriesFilterView.dart';
import 'package:eshop_pro/ui/screens/productFilters/widgets/priceFilterView.dart';
import 'package:eshop_pro/ui/screens/productFilters/widgets/selectedFilterView.dart';
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        if ((double.tryParse(minPriceTextEditingController.text
                          ...
                          Utils.showSnackBar(
                              message:
                                  "Min price should be greater than ${widget.minPrice}",
                              context: context);
                          return;
                        }
                        ...
                        if ((double.tryParse(maxPriceTextEditingController.text
                          ...
                          Utils.showSnackBar(
                              message:
                                  "Max price should be less than ${widget.maxPrice}",
                              context: context);
                          return;
                        }
