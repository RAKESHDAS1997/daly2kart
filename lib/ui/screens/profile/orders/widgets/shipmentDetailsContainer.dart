...
import 'package:eshop_pro/cubits/order/productFileDownloadLinkCubit.dart';
import 'package:eshop_pro/cubits/order/updateOrderCubit.dart';
import 'package:eshop_pro/data/models/product.dart';
import 'package:eshop_pro/ui/screens/profile/orders/widgets/orderStatusItem.dart';
import 'package:eshop_pro/ui/screens/profile/orders/widgets/setProductRatingContainer.dart';
  ...
  buildSelectedItemContainer(OrderItems orderItem) {
    return Column(
      children: [
        ...
        DesignConfig.smallHeightSizedBox,
        //user can give rating only if the order is delivered
                  ...
                  onTap: () {
                    Utils.openAlertDialog(context, onTapYes: () {
                      context.read<UpdateOrderCubit>().updateOrder(params: {
                        Api.orderItemIdApiKey: _selectedOrder.id,
                        Api.statusApiKey: cancelledStatusType,
                      });
              ...
              return CustomRoundedButton(
                  ...
                  onTap: () {
                    Utils.openAlertDialog(context, onTapYes: () {
                      context.read<UpdateOrderCubit>().updateOrder(params: {
                        Api.orderItemIdApiKey: _selectedOrder.id,
                        Api.statusApiKey: returnedStatusType,
                      });
                      Navigator.of(context).pop();
                    },
