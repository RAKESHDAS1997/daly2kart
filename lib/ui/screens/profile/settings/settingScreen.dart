...
import 'package:eshop_pro/ui/widgets/customCuperinoSwitch.dart';
...
class _SettingScreenState extends State<SettingScreen>
  ...
  Widget build(BuildContext context) {
    fontColor = Theme.of(context).colorScheme.secondary.withOpacity(0.8);
    return Scaffold(
                ...
                switch (index) {
                  ...
                  case 1:
                    Hive.box(settingsBoxKey)
                        .put(notificationEmailHiveKey, value);
                    break;
                  case 2:
                    Hive.box(settingsBoxKey).put(notificationSMSHiveKey, value);
                    break;
                }
